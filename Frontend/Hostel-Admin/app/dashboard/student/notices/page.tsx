  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-4">
        ...
        <p className="text-lg font-medium text-muted-foreground">Loading notices...</p>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-8">
      <div className="flex flex-col gap-2">
        <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">Hostel Notices</h1>
      ...
      <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
        <div className="relative w-full md:w-96">
          ...
          <Input
            ...
            className="w-full pl-10 h-11 text-base border-2 border-gray-200 dark:border-gray-700 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            value={searchTerm}
        ...
        <div className="flex gap-3 w-full md:w-auto">
          <Select value={categoryFilter} onValueChange={setCategoryFilter}>
            <SelectTrigger className="w-[180px] h-11 border-2 border-gray-200 dark:border-gray-700">
              <SelectValue placeholder="All Categories" />
            </SelectTrigger>
            <SelectContent className="border-2 border-gray-200 dark:border-gray-700">
              <SelectItem value="all" className="text-base hover:bg-gray-100 dark:hover:bg-gray-800">All Categories</SelectItem>
              <SelectItem value="general" className="text-base hover:bg-gray-100 dark:hover:bg-gray-800">General</SelectItem>
              <SelectItem value="academic" className="text-base hover:bg-gray-100 dark:hover:bg-gray-800">Academic</SelectItem>
              <SelectItem value="events" className="text-base hover:bg-gray-100 dark:hover:bg-gray-800">Events</SelectItem>
              <SelectItem value="maintenance" className="text-base hover:bg-gray-100 dark:hover:bg-gray-800">Maintenance</SelectItem>
            </SelectContent>
          </Select>
          <Button 
            variant="outline" 
            ...
            className="h-11 gap-1 border-2 border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800"
          >
            <RefreshCw className="h-4 w-4" />
            Reset
          </Button>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid grid-cols-2 h-12 bg-gray-100 dark:bg-gray-800 p-1">
          <TabsTrigger 
            value="active" 
            className="data-[state=active]:bg-white data-[state=active]:shadow-sm data-[state=active]:border data-[state=active]:border-gray-200 dark:data-[state=active]:bg-gray-900 dark:data-[state=active]:border-gray-700 py-2 text-base font-medium transition-all"
          >
            Active Notices
          </TabsTrigger>
          <TabsTrigger 
...
function NoticeCard({ 
  ...
  return (
    <Card className={cn(
      ...
      isActive ? "border-gray-200 dark:border-gray-700" : "border-gray-100 dark:border-gray-800 bg-muted/30"
    )}>
          ...
          <div className="flex flex-wrap gap-3">
            {notice.attachments.map((attachment) => (
              <a 
                ...
                className="text-sm font-medium text-primary hover:text-primary/90 flex items-center gap-2 px-3 py-1.5 bg-primary/10 rounded-md hover:bg-primary/20 transition-colors"
              >
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 gap-6 text-center">
      ...
      <Button 
        ...
        className="gap-2 border-2 border-gray-200 dark:border-gray-700 h-11 px-6"
      >
        <RefreshCw className="h-4 w-4" />
        Clear all filters
      </Button>
